	...
	<cffunction name="loadPoi" access="private" output="false" returntype="any">
		...
		<cfscript>
			if( NOT structKeyExists( server, "_poiLoader")){
				...
				arrayAppend(Local.paths, expandPath('{railo-web-directory}'&'/lib/xmlbeans-2.6.0.jar'));
				arrayAppend(Local.paths, expandPath('{railo-web-directory}'&'/lib/displaytag-export-poi-1.2.jar'));
